...
namespace Data.cs.Interfaces.Catalogos
{
    public interface IServiciosRepositorio
    {
        ...
        Task<Response<List<EntServiceItem>>> DGetListActive(Guid uIdSucursal);
        Task<Response<List<EntServiceItem>>> DGetListPreAssigment(Guid uIdSucursal);
        Task<Response<bool>> DSaveToSucursal(List<EntServiceItem> entities, Guid uIdSucursal);
    }
}
