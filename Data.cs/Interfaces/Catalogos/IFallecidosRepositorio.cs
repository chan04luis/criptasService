...
public interface IFallecidosRepositorio
{
    ...
    Task<Response<EntFallecidos>> DUpdateDocs(EntFallecidos entity);
    ...
    Task<Response<PagedResult<FallecidosBusqueda>>> DGetFallecidos(EntFallecidosSearchRequest fallecido);
}
